    ...
    <div class="pro-list-card" id="pro-list-${pro.id}" style="background:#ffffff;border-radius:18px;padding:16px;gap:16px;display:flex;align-items:flex-start;position:relative;box-shadow:0 4px 15px rgba(0,0,0,0.04);border:1px solid #f8f9fa;">
      ...
      <div style="display:flex;flex-direction:column;align-items:center;">
        ...
        <div style="font-size:.85rem;color:#1a1a1a;font-weight:800;display:flex;align-items:center;gap:4px;
          ...
          margin-top:-2px;z-index:2;cursor:default;">
          ⭐ ${pro.rating || 0}
        </div>
      </div>
      ...
      <div onclick="${profileLink}" style="flex:1;cursor:pointer;padding-top:2px;padding-right:45px;min-width:0;">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;">
          <div style="display:flex;flex-wrap:wrap;gap:6px;">
            ${pro.distance != null ? `<div style="background:#EBF3FF;color:#0d6efd;padding:4px 10px;border-radius:12px;font-size:.72rem;font-weight:700;display:inline-flex;align-items:center;gap:4px;">📌 ${formatDistance(pro.distance)}</div>` : ''}
            ${pro.is_verified ? '<div style="background:#E5FDF4;color:#059669;padding:4px 10px;border-radius:12px;font-size:.72rem;font-weight:700;display:inline-flex;align-items:center;gap:4px;">✓ Verificado</div>' : ''}
          </div>
        </div>
      </div>
