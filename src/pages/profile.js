...
export async function renderProfile(params = {}) {
  ...
  content.innerHTML = `
    ...
    <div class="profile-actions">
      <a href="https://wa.me/${pro.whatsapp}?text=${encodeURIComponent('Hola, te contacto desde NexoPro. Me gustaría consultarte sobre tus servicios.')}" target="_blank" class="profile-action-btn whatsapp" id="profile-wa-btn">
